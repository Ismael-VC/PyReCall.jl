# Finding python. This is slightly complicated in order to support using PyReCall
...
if !symbols_present
    ...
    isfile(depfile) || error("PyReCall not properly installed. Please run Pkg.build(\"PyReCall\")")
    include(depfile) # generated by Pkg.build("PyReCall")
